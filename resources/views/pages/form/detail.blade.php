                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th colspan="5" style="text-align: right">Jumlah Uang</th>
                                <td style="text-align: right"> {{ number_format($show->jumlah_dana, 0, ',',
                                    '.') }}</td>
                            </tr>
                        </tbody>
                    </table>
...
<div class="col-xl-4 col-md-6 order-2 order-lg-1">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('form.kPembayaran', $show->id) }}" method="POST" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="d-none">
                    <div class="row">
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="mb-1">
                                ...
                                <input type="hidden" name="departement_id" value="{{ $show->departement_id }}" />
                                <input type="hidden" name="departement_id" value="{{ $show->departement_id }}" />
                                <input type="hidden" name="tgl_terima_dana" value="{{ $show->tgl_terima_dana }}" />
                                <input type="hidden" name="jumlah_dana" value="{{ $show->jumlah_dana }}" />
                                <input type="hidden" name="jumlah_total" value="{{ $show->jumlah_total }}" />
                ...
                <div class="mb-3">
                    <button type="submit" class="btn btn-success float-end ms-2"> <span class="ti ti-check"></span>
                        &nbsp; Process</button>
                    <a href="{{ route('form.index') }}" class="btn btn-secondary float-end ">Back</a>
            </form>
        </div>
    </div>
</div>
