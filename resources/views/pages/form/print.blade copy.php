        ...
        <table class="table table-bordered tab mt-4">
            ...
            <tbody>
                <tr>
                    ...
                    <th>{{ $data->qty }}</th>
                    <th>{{ $data->unit }}</th>
                    <th style="text-align: right"> {{ number_format($data->price, 0, ',', '.',) }}
                    </th>
                    <th style="text-align: right"> {{ number_format($data->total, 0, ',', '.') }}
                    </th>
                </tr>
                <tr>
                    <th>2</th>
                    <th>{{ $data->description2 }} </th>
                    <th>{{ $data->qty2 }}</th>
                    <th>{{ $data->unit2 }}</th>
                    ...
                    <th style="text-align: right">
                        ...
                        @break
                        @default
                        {{ number_format($data->total2, 0, ',', '.') }}
                        @endswitch
                    </th>
                </tr>
                <tr>
                    <th>3</th>
                    <th>{{ $data->description3 }} </th>
                    <th>{{ $data->qty3 }}</th>
                    <th>{{ $data->unit3 }}</th>
                    <th style="text-align: right">
                        @switch($data)
                    ...
                    <th style="text-align: right">
                        ...
                        @break
                        @default
                        {{ number_format($data->total3, 0, ',', '.') }}
                        @endswitch
                    </th>
                </tr>
                <tr>
                    <th>4</th>
                    <th>{{ $data->description4 }} </th>
                    <th>{{ $data->qty4 }}</th>
                    <th>{{ $data->unit4 }}</th>
                    <th style="text-align: right">
                        @switch($data)
                    ...
                    <th style="text-align: right">
                        ...
                        @break
                        @default
                        {{ number_format($data->total4, 0, ',', '.') }}
                        @endswitch
                    </th>
                </tr>
                <tr>
                    <th>5</th>
                    <th>{{ $data->description5 }} </th>
                    <th>{{ $data->qty5 }}</th>
                    <th>{{ $data->unit5 }}</th>
                    <th style="text-align: right">
                        @switch($data)
                        @case($data->price5 == null)
                        @break
                        @default
                        {{ number_format($data->price5, 0, ',', '.') }}
                        @endswitch
                    </th>
                    <th style="text-align: right">
                        @switch($data)
                        ...
                        @break
                        @default
                        {{ number_format($data->total5, 0, ',', '.') }}
                        @endswitch
                    </th>
                </tr>
                <tr>
                    <th>6</th>
                    <th>{{ $data->description6 }} </th>
                    <th>{{ $data->qty6 }}</th>
                    <th>{{ $data->unit6 }}</th>
                    <th style="text-align: right">
                        @switch($data)
                        @case($data->price6 == null)
                        @break
                        @default
                        {{ number_format($data->price6, 0, ',', '.') }}
                        @endswitch
                    </th>
                    <th style="text-align: right">
                        @switch($data)
                        ...
                        @break
                        @default
                        {{ number_format($data->total6, 0, ',', '.') }}
                        @endswitch
                    </th>
                </tr>
                <tr>
                    <th>7</th>
                    <th>{{ $data->description7 }} </th>
                    <th>{{ $data->qty7 }}</th>
                    <th>{{ $data->unit7 }}</th>
                    <th style="text-align: right">
                        @switch($data)
                        @case($data->price7 == null)
                        @break
                        @default
                        {{ number_format($data->price7, 0, ',', '.') }}
                        @endswitch
                    </th>
                    <th style="text-align: right">
                        @switch($data)
                        ...
                        @break
                        @default
                        {{ number_format($data->total7, 0, ',', '.') }}
                        @endswitch
                    </th>
                </tr>
                <tr>
                    <th>8</th>
                    <th>{{ $data->description8 }} </th>
                    <th>{{ $data->qty8 }}</th>
                    <th>{{ $data->unit8 }}</th>
                    <th style="text-align: right">
                        @switch($data)
                        @case($data->price8 == null)
                        @break
                        @default
                        {{ number_format($data->price8, 0, ',', '.') }}
                        @endswitch
                    </th>
                    <th style="text-align: right">
                        @switch($data)
                        ...
                        @break
                        @default
                        {{ number_format($data->total8, 0, ',', '.') }}
                        @endswitch
                    </th>
                </tr>
                <tr>
                    <th colspan="5" style="text-align: right">TOTAL</th>
                    <th style="text-align: right"> {{ number_format($data->jumlah_total, 0, ',',
                        '.') }}</th>
                </tr>
            </tbody>
        </table>
