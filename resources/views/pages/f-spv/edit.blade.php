...
<div class="col-xl-12">
    <div class="card">
        <form action="{{ route('form-spv.update', $edit->id) }}" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="col-12 text-center mb-4 mt-1 pt-20">
                <a href="{{ route('form-spv.index') }}" class="btn btn-outline-secondary me-1">Back</a>
