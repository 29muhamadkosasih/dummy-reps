    ...
    <div class="card">
        <div class="card-body mt-2">
            <div class="row mb-3" style="text-align right">
                ...
                <div class="col-auto">
                    <a href="{{ route('form-man.index') }}" class="btn btn-secondary">Back</a>
                </div>
            </div>
            <div class="row">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    @break
                                    @default
                                    <a href="{{ url('form/download-man/' . $show->image1) }}" target="_blank"
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @break
                                    @default
                                    <a href="{{ url('form/download-man/' . $show->image2) }}" target="_blank"
                                        class="text-primary font-weight-bold"> <i data-feather="download"></i>
                                        {{ $show->image2 }}
                                    </a>
                                    @endswitch
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @break
                                    @default
                                    <a href="{{ url('form/download-man/' . $show->image3) }}" target="_blank"
                                        class="text-primary font-weight-bold"> <i data-feather="download"></i>
                                        {{ $show->image3 }}
                                    </a>
                                    @endswitch
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @break
                                    @default
                                    <a href="{{ url('form/download-man/' . $show->image4) }}" target="_blank"
                                        class="text-primary font-weight-bold"> <i data-feather="download"></i>
                                        {{ $show->image4 }}
                                    </a>
                                    @endswitch
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @break
                                    @default
                                    <a href="{{ url('form/download-man/' . $show->image5) }}" target="_blank"
                                        class="text-primary font-weight-bold"> <i data-feather="download"></i>
                                        {{ $show->image5 }}
                                    </a>
                                    @endswitch
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @break
                                    @default
                                    <a href="{{ url('form/download-man/' . $show->image6) }}" target="_blank"
                                        class="text-primary font-weight-bold"> <i data-feather="download"></i>
                                        {{ $show->image6 }}
                                    </a>
                                    @endswitch
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @break
                                    @default
                                    <a href="{{ url('form/download-man/' . $show->image7) }}" target="_blank"
                                        class="text-primary font-weight-bold"> <i data-feather="download"></i>
                                        {{ $show->image7 }}
                                    </a>
                                    @endswitch
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @break
                                    @default
                                    <a href="{{ url('form/download-man/' . $show->image8) }}" target="_blank"
                                        class="text-primary font-weight-bold"> <i data-feather="download"></i>
                                        {{ $show->image8 }}
                                    </a>
                                    @endswitch
