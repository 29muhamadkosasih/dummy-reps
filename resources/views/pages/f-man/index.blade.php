                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                @break
                                @default
                                <a href="{{ url('approveman/konfirmasiRem', $data->id) }}"
                                    class="btn btn-icon btn-success btn-sm">
                                    <span class="ti ti-check"></span>
                                </a>
                                @endswitch
                                ...
                                @break
                                @case($data->status == 6)
                                <a href="{{ route('form-man.detail', $data->id) }}" class="btn btn-icon btn-primary btn-sm">
                                ...
                                <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                    action="{{ route('form-man.destroy', $data->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <a href=" {{ route('form-man.show', $data->id) }}"
                                        class="btn btn-icon btn-secondary btn-sm">
                                        <span class="ti ti-eye"></span>
                                    </a>

                                    <a href="{{ route('form-man.edit', $data->id) }}"
    ...
    <div class="modal-dialog modal-lg modal-simple modal-edit-user">
        <div class="modal-content p-2 p-md-4">
            <div class="modal-body">
                ...
                <form action="{{ route('form-man.store') }}" method="POST" class="row g-3"
